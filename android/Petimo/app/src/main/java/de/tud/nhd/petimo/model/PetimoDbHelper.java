...
public class PetimoDbHelper extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_MONITOR =
    ...
    private static final String DATABASE_NAME = "Petimo.db";

    protected PetimoDbHelper(Context context, int dbVersion) {
